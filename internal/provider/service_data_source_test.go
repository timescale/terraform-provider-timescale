...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.timescale_service.data_source", "resources.0.spec.enable_ha_replica"),
					resource.TestCheckResourceAttrSet("data.timescale_service.data_source", "resources.0.spec.ha_replicas"),
					resource.TestCheckResourceAttrSet("data.timescale_service.data_source", "resources.0.spec.sync_replicas"),
				),
			},
		},
	})
